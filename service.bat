...
echo 3. FixRoblox (%GameFilterStatus%)
...
if "%menu_choice%"=="3" goto game_switch
if "%menu_choice%"=="4" goto ipset_switch
if "%menu_choice%"=="5" goto ipset_update
if "%menu_choice%"=="52" goto service_status
if "%menu_choice%"=="42" goto service_check_updates
